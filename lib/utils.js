...
underscore.defaults = function defaults(obj, from1, from2) {
  var key;
  if (from1) for (key in from1) if (obj[key] === undefined) obj[key] = from1[key];
  if (from2) for (key in from2) if (obj[key] === undefined) obj[key] = from2[key];
  return obj;
};

underscore.extend = function extend(obj, from1, from2) {
  var key;
  if (from1) for (key in from1) obj[key] = from1[key];
  if (from2) for (key in from2) obj[key] = from2[key];
  return obj;
};
